...
def gen_data(data, num_products, num_users, va_ratio=0.2, te_ratio=0.2, det_reward=False, det_reward_thres=0.02, accum=True, use_id=True):
...
def main():
    ...
    env_1_args['random_seed_for_user'] = 2048
